...
const validateReason = () => {
  ...
  } else if (formData.value.reason.trim().length < 20) {
    errors.value.reason = "Reason must be at least 20 characters long";
  } else {
...
const submitForm = () => {
  ...
  if (!Object.values(errors.value).some(v => v !== null)) {
