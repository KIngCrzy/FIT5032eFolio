...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li><strong>Weekdays:</strong> {{ bookstores.openingHours.weekdays.open }} - {{
          bookstores.openingHours.weekdays.close }}</li>
        <li><strong>Weekends:</strong> {{ bookstores.openingHours.weekends.open }} - {{
          bookstores.openingHours.weekends.close }}</li>
      </ul>
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="author in authors" :key="author.id"
            :title="author.name === 'George Orwell' ? 'Very famous!' : 'Famous!'"
            :class="{'highlight': author.name === 'George Orwell'}"
            :style="author.name === 'George Orwell' ? { backgroundColor: bgColor } : {}">
          {{ author.name }} ({{ author.birthYear }})
        </li>
      </ul>
    </section>
